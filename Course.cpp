...
void Course::afficherGrilleScore(){
    std::cout<<"-----------------------------"<<std::endl;
    std::cout<< "| ID course : "<<_identifiant<<" |"<< std::endl; 
    std::cout<<"---------------------------------------------------------------------"<<std::endl;
...
Course::Course(std::string identifiant, std::string type) : _identifiant("Course tier 1"), _typeCourse("Facile"),_scoreJoueur1(5),_scoreJoueur2(4),_scoreJoueur3(3),_scoreJoueur4(2),_scoreEnregistrer(000){}